    ...
    >
      <div className="relative w-full h-32 sm:h-40">
        ...
        {product.stock <= 5 && product.stock > 0 && (
          <div className="absolute top-1 sm:top-2 right-1 sm:right-2 bg-orange-500 text-white text-xs px-1.5 sm:px-2 py-0.5 sm:py-1 rounded-full">
      ...
      <div className="p-3 sm:p-4">
        ...
        <p className="text-xs sm:text-sm text-gray-600 mb-2 sm:mb-3 h-8 sm:h-10 overflow-hidden line-clamp-2"> {/* Added line-clamp-2 for better text control */}
          {product.description ? truncateText(product.description, 60) : 'Sin descripción disponible'}
        </p>

        <div className="flex justify-between items-center mb-2 sm:mb-0">
          <span className="text-teal-700 text-lg sm:text-xl font-bold">
        ...
        <div className="mt-2 sm:mt-3">
          <div className="flex items-center justify-center space-x-1 sm:space-x-2 bg-gradient-to-r from-teal-600 to-teal-700 text-white py-1.5 sm:py-2 px-3 sm:px-4 rounded-lg shadow-md hover:shadow-lg hover:from-teal-700 hover:to-teal-800 transform hover:scale-105 transition-all duration-300">
            <svg
