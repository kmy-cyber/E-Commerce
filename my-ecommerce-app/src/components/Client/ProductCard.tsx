  ...
  return (
    <div className="bg-white rounded-xl shadow-md overflow-hidden transform hover:scale-105 transition-all duration-300 flex flex-col h-full"> {/* Sombra más sutil */}
      ...
      <div className="p-6 flex-grow flex flex-col">
        <h3 className="text-2xl font-bold text-gray-800 mb-2">{product.name}</h3> {/* Título más sobrio */}
        ...
        <div className="flex items-center space-x-3 mb-4">
          <input
            ...
            className="w-20 p-2 border border-gray-300 rounded-lg text-center focus:ring-gray-500 focus:border-gray-500"
          />
          <button
            onClick={handleAddToCart}
            disabled={product.stock === 0}
            className={`flex-grow py-3 px-6 rounded-full font-bold text-white shadow-lg transform hover:scale-105 transition-all duration-300 ${
